...
git clone --depth 1 --branch master https://github.com/ftc8404/auth-api-kafka-docker.git
cd auth-api-kafka-docker
...
kafka-configs.sh --zookeeper zookeeper:2181 --alter --entity-type topics --entity-name users --add-config retention.ms=1000

kafka-configs.sh --zookeeper zookeeper:2181 --alter --entity-type topics --entity-name users --delete-config retention.ms
